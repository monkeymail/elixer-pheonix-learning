defmodule PasswordGenerator do
  @moduledoc """
  Generates a random password depending on parameters, Module's main function is "generate(options)".
  ...
  There are 4 options 'length', 'numbers', 'uppercase', 'symbols.
  """
  ...
  # Elixir is a dynamic language, but we can type check by specifying what type fo data we want.
  # This can be used with type checking tools.
